...
## EC2
Create an EC2 instance with other relevant components with these commands. Please refer to this [post](https://dev.to/aws-builders/aws-ec2-launch-instances-the-hard-way-with-cli-2ga3) for explanation on what each of these commands does.
```
$ mkdir ~/.aws
